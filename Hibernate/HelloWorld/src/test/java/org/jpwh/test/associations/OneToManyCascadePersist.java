...
import org.jpwh.simple.model.associations.onetomany.cascadepersist.Bid;
import org.jpwh.simple.model.associations.onetomany.cascadepersist.Item;
...
public class OneToManyCascadePersist extends JPATest {
    ...
    public void storeAndLoadItemBids() throws Exception {
        ...
        try {
            ...
            Item someItem = new Item("Some Item1");
